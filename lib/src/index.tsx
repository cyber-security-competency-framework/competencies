...
import { App } from "./App";
import type { ElementWrapperProps } from "./components/ElementWrapper";
import type { HeadingWrapperProps } from "./components/HeadingWrapper";
...
export type MarkdownToMatrixProps = {
  ...
  /** if provided, renders a logo image above the title */
  logo?: string;
...
// additional exports
export type { ElementWrapperProps, HeadingWrapperProps };
